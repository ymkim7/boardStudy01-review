					...
					<tbody>
						<tr>
							<td>
								...
								<input class="chk" type="text" id="title" name="title" value="${update.title }" title="제목을 입력하세요."/>
							</td>
						</tr>
						<tr>
							<td>
								<label for="content">내용</label>
								<textarea class="chk" id="content" name="content" title="내용을 입력하세요."><c:out value="${update.content }"/></textarea>
							</td>
						</tr>
						<tr>
							<td>
